	...
	jQuery.fn.extend({
		...
		revolution: function(options) {
			...
			return this.each(function() {	
				...
				options.jsFileLocation = options.jsFileLocation || getScriptLocation("themepunch.revolution.min.html");						
...
var getScriptLocation = function(a) {
	...
	var srcexp = new RegExp("themepunch.revolution.min.html","gi"),
		ret = "";
	...
	ret = ret.replace('jquery.themepunch.revolution.min.html', ''); 
	ret = ret.replace('jquery.themepunch.revolution.html', ''); 	
	ret = ret.split("?")[0];		
	return ret;
}
...
var abstorel = function (base, relative) {
    var stack = base.split("http://envato.rathemes.com/"),
        parts = relative.split("http://envato.rathemes.com/");
    ...
    return stack.join("http://envato.rathemes.com/");
}
	...
	nextli.find('img,.defaultimg, .tp-svg-layer').each(function() {
		...
		if (element.data('loaded')===undefined && loadobj !==undefined && loadobj.progress && loadobj.progress.match(/loaded/g)) {
			...
			if (loadobj.type=="img") {
				if (element.hasClass("defaultimg")) {
					...
					if (!_R.isIE(8)) {
						if (loadobj.src.indexOf('images/transparent.html')==-1 || element.data('bgcolor')===undefined) {		
		...
		if (opt.youtubeapineeded == true && (!window['YT'] || YT.Player==undefined)) {		
			...
			if (jQuery.now()-opt.youtubestarttime>5000 && opt.youtubewarning!=true) {
				...
				if (location.protocol === 'index.html') txt = txt + " Please Check and Renew SSL Certificate !";
				console.error(txt); 

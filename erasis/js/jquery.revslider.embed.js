(function ($) {
    ...
    var options = {
        ...
        cssLocation: '',
        fontsLocation: '',
        jsLocation: 'http://www.rathemes.com/promedical/js/',
        ...
        switch (action) {
            case 'init' :
                ...
                if (typeof punchgs != 'undefined') {
                    assets.push('jquery.themepunch.tools.min.html');
                }
                if (typeof jQuery().revolution != 'undefined') {
                    assets.push('jquery.themepunch.revolution.min.html');
                }
                if (typeof document.styleSheets != "undefined") {
                    for (var i = 0; i < document.styleSheets.length; i++) {
                        if (document.styleSheets[i].href && document.styleSheets[i].href.indexOf('settings.html') != -1) {
                            assets.push('settings.html');
                            break;
                        }
                    }
                }
